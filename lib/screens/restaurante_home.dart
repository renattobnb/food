import 'package:appfood/screens/menu.dart';
import 'package:appfood/screens/retaurante_home_detail.dart';
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      body: ZoomDrawer(
        ...
        mainScreen: RestauranteHomeDetail(drawerZoomController),
        borderRadius: 24.0,
        showShadow: true,
        angle: 0.0,
