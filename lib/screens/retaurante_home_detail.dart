...
import 'package:appfood/view_model/restaurante_home_detail_vm/restaurate_home_detail_vm_imp.dart';
import 'package:appfood/widgtes/restaurante_home_detail_widget/mostrarListaMaisPopulares.dart';
...
class RestauranteHomeDetail extends StatelessWidget {

  final MainStateController mainStateController = Get.find();
  final RestauranteHomeDetailViewModel viewModel = RestauranteHomeDetailViewModelImp();
  final ZoomDrawerController zoomDrawerController;

  RestauranteHomeDetail(this.zoomDrawerController);
